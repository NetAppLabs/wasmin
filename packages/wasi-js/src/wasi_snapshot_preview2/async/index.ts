...
import { ClocksWallClockNamespace } from "@wasm-env/wasi-snapshot-preview2";
type ClocksWallClockAsync = ClocksWallClockNamespace.WasiClocksWallClockAsync;
import { ClocksTimezoneNamespace } from "@wasm-env/wasi-snapshot-preview2";
type ClocksTimezoneAsync = ClocksTimezoneNamespace.WasiClocksTimezoneAsync;
import { SocketsInstanceNetworkNamespace } from "@wasm-env/wasi-snapshot-preview2";
type SocketsInstanceNetworkAsync = SocketsInstanceNetworkNamespace.WasiSocketsInstanceNetworkAsync;
import { SocketsNetworkNamespace } from "@wasm-env/wasi-snapshot-preview2";
type SocketsNetworkAsync = SocketsNetworkNamespace.WasiSocketsNetworkAsync;
import { SocketsTcpCreateSocketNamespace } from "@wasm-env/wasi-snapshot-preview2";
