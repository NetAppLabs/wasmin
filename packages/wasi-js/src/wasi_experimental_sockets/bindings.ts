...
export function addWasiExperimentalSocketsToImports(imports: any, obj: WasiExperimentalSocketsAsync, handler: WasiExperimentalSocketsHandler, ): void {
        if (!("wasi_experimental_sockets" in imports)) imports["wasi_experimental_sockets"] = {};
        imports["wasi_experimental_sockets"]["addr_resolve"] = async function (_host_ptr: any,_host_len: any,_port: any,_buf: any,_buf_len: any,_result_ptr: any) {
        ...
        imports["wasi_experimental_sockets"]["sock_recv"] = async function (_fd: any,_buf: any,_buf_len: any,_flags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_experimental_sockets"]["sock_recv_from"] = async function (_fd: any,_buf: any,_buf_len: any,_addr_buf: any,_addr_buf_len: any,_flags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_experimental_sockets"]["sock_send"] = async function (_fd: any,_buf: any,_buf_len: any,_flags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_experimental_sockets"]["sock_send_to"] = async function (_fd: any,_buf: any,_buf_len: any,_addr: any,_flags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
