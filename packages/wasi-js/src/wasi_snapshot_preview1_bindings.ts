...
export function addWasiSnapshotPreview1ToImports(
    ...
    imports["wasi_snapshot_preview1"]["path_create_directory"] = async function (
        ...
        try {
            ...
            console.log("getting error thrown from pathCreateDirectory: ", err);
            const retError = errorHandler2(err);
            console.log("returning as: ", retError);
            return retError;
        }
    };
