...
export function addWasiSnapshotPreview1ToImports(imports: any, obj: WasiSnapshotPreview1Async, handler: WasiSnapshotPreview1Handler, ): void {
        ...
        imports["wasi_snapshot_preview1"]["fd_fdstat_set_rights"] = async function (_fd: any,_fs_rights_base: any,_fs_rights_inheriting: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_filestat_set_times"] = async function (_fd: any,_atim: any,_mtim: any,_fst_flags: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_pread"] = async function (_fd: any,_iovs_ptr: any,_iovs_len: any,_offset: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_pwrite"] = async function (_fd: any,_iovs_ptr: any,_iovs_len: any,_offset: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_read"] = async function (_fd: any,_iovs_ptr: any,_iovs_len: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_readdir"] = async function (_fd: any,_buf: any,_buf_len: any,_cookie: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_seek"] = async function (_fd: any,_offset: any,_whence: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["fd_write"] = async function (_fd: any,_iovs_ptr: any,_iovs_len: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_create_directory"] = async function (_fd: any,_path_ptr: any,_path_len: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_filestat_get"] = async function (_fd: any,_flags: any,_path_ptr: any,_path_len: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_filestat_set_times"] = async function (_fd: any,_flags: any,_path_ptr: any,_path_len: any,_atim: any,_mtim: any,_fst_flags: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_link"] = async function (_old_fd: any,_old_flags: any,_old_path_ptr: any,_old_path_len: any,_new_fd: any,_new_path_ptr: any,_new_path_len: any) {
            const errorHandler2 = handler.handleError
            try {
                        const ret = await obj.pathLink(_old_fd,_old_flags,_old_path_ptr,_old_path_len,_new_fd,_new_path_ptr,_new_path_len);
                        handler.checkAbort();
                        return ret;
            } catch(err: any) {
                        return errorHandler2(err);
        ...
        imports["wasi_snapshot_preview1"]["path_open"] = async function (_fd: any,_dirflags: any,_path_ptr: any,_path_len: any,_oflags: any,_fs_rights_base: any,_fs_rights_inheriting: any,_fdflags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
                        const ret = await obj.pathOpen(_fd,_dirflags,_path_ptr,_path_len,_oflags,_fs_rights_base,_fs_rights_inheriting,_fdflags,_result_ptr);
                        handler.checkAbort();
                        return ret;
            } catch(err: any) {
                        return errorHandler2(err);
        ...
        imports["wasi_snapshot_preview1"]["path_readlink"] = async function (_fd: any,_path_ptr: any,_path_len: any,_buf: any,_buf_len: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_remove_directory"] = async function (_fd: any,_path_ptr: any,_path_len: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_rename"] = async function (_fd: any,_old_path_ptr: any,_old_path_len: any,_new_fd: any,_new_path_ptr: any,_new_path_len: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["path_symlink"] = async function (_old_path_ptr: any,_old_path_len: any,_fd: any,_new_path_ptr: any,_new_path_len: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["poll_oneoff"] = async function (_in_: any,_out: any,_nsubscriptions: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["proc_exit"] = async function (_rval: any) {
            ...
            console.log("handled error", err, eRet);
            }
        ...
        imports["wasi_snapshot_preview1"]["sock_recv"] = async function (_fd: any,_ri_data_ptr: any,_ri_data_len: any,_ri_flags: any,_result_0_ptr: any,_result_1_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
        ...
        imports["wasi_snapshot_preview1"]["sock_send"] = async function (_fd: any,_si_data_ptr: any,_si_data_len: any,_si_flags: any,_result_ptr: any) {
            const errorHandler2 = handler.handleError
            try {
