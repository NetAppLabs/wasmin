...
export function promisifyImportObjectNamespace(nsImportObj: any, mod: WebAssembly.Module) {
    ...
    importFuncNames.forEach((importFuncName: string) => {
        ...
        if (typeof realImportFunc === 'function') {
            if (
                (importFuncName != "__defineGetter__") &&
                (importFuncName != "__defineSetter__") &&
                (importFuncName != "hasOwnProperty") &&
                (importFuncName != "__lookupGetter__") &&
                (importFuncName != "__lookupSetter__") &&
                (importFuncName != "isPrototypeOf") &&
                (importFuncName != "propertyIsEnumerable") &&
                (importFuncName != "toString") &&
                (importFuncName != "valueOf") &&
                (importFuncName != "toLocaleString")
            ){
