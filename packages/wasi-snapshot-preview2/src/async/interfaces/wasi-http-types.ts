export interface WasiHttpTypes {
   ...
   * http-related errors.
   */
   httpErrorCode(err: IoError): Promise<ErrorCode | undefined>;
  /**
...
export interface OutgoingRequest extends AsyncDisposable {
  body(): Promise<OutgoingBody>;
  method(): Promise<Method>;
  setMethod(method: Method): Promise<void>;
  pathWithQuery(): Promise<string | undefined>;
  setPathWithQuery(pathWithQuery: string | undefined): Promise<void>;
  scheme(): Promise<Scheme | undefined>;
  setScheme(scheme: Scheme | undefined): Promise<void>;
  authority(): Promise<string | undefined>;
  setAuthority(authority: string | undefined): Promise<void>;
  headers(): Promise<Headers>;
}
