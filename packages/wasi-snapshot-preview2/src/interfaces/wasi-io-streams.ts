export interface WasiIoStreamsAsync {
  /**
   ...
   */
   read(this_: InputStream, len: bigint): Promise<[Uint8Array, StreamStatus]>;
  /**
   * Read bytes from a stream, after blocking until at least one byte can
   * be read. Except for blocking, identical to `read`.
   */
   blockingRead(this_: InputStream, len: bigint): Promise<[Uint8Array, StreamStatus]>;
  /**
   ...
   */
   skip(this_: InputStream, len: bigint): Promise<[bigint, StreamStatus]>;
  /**
   * Skip bytes from a stream, after blocking until at least one byte
   * can be skipped. Except for blocking behavior, identical to `skip`.
   */
   blockingSkip(this_: InputStream, len: bigint): Promise<[bigint, StreamStatus]>;
  /**
   ...
   */
   subscribeToInputStream(this_: InputStream): Promise<Pollable>;
  /**
   ...
   */
   dropInputStream(this_: InputStream): Promise<void>;
  /**
   ...
   * 1 byte, or an error.
   */
   checkWrite(this_: OutputStream): Promise<bigint>;
  /**
   ...
   */
   write(this_: OutputStream, contents: Uint8Array): Promise<void>;
  /**
   ...
   * while !contents.is_empty() {
     ...
     * ```
     */
     blockingWriteAndFlush(this_: OutputStream, contents: Uint8Array): Promise<void>;
    /**
     ...
     */
     flush(this_: OutputStream): Promise<void>;
    /**
     * Request to flush buffered output, and block until flush completes
     * and stream is ready for writing again.
     */
     blockingFlush(this_: OutputStream): Promise<void>;
    /**
     ...
     * all derived `pollable`s created with this function are dropped.
     */
     subscribeToOutputStream(this_: OutputStream): Promise<Pollable>;
    /**
     ...
     */
     writeZeroes(this_: OutputStream, len: bigint): Promise<void>;
    /**
     ...
     */
     splice(this_: OutputStream, src: InputStream, len: bigint): Promise<[bigint, StreamStatus]>;
    /**
     ...
     */
     blockingSplice(this_: OutputStream, src: InputStream, len: bigint): Promise<[bigint, StreamStatus]>;
    /**
     ...
     * the output stream.
     */
     forward(this_: OutputStream, src: InputStream): Promise<[bigint, StreamStatus]>;
    /**
     ...
     */
     dropOutputStream(this_: OutputStream): Promise<void>;
  }
