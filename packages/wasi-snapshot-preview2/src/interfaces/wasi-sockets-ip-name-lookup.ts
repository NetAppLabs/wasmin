export interface WasiSocketsIpNameLookupAsync {
  /**
   ...
   */
   resolveAddresses(network: Network, name: string, addressFamily: IpAddressFamily | undefined, includeUnavailable: boolean): Promise<ResolveAddressStream>;
  /**
   ...
   */
   resolveNextAddress(this_: ResolveAddressStream): Promise<IpAddress | undefined>;
  /**
   * Dispose of the specified `resolve-address-stream`, after which it may no longer be used.
   * 
   * Note: this function is scheduled to be removed when Resources are natively supported in Wit.
   */
   dropResolveAddressStream(this_: ResolveAddressStream): Promise<void>;
  /**
   ...
   */
   subscribe(this_: ResolveAddressStream): Promise<Pollable>;
}
