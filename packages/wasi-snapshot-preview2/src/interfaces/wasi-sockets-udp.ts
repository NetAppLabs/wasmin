export interface WasiSocketsUdpAsync {
  /**
   ...
   */
   startBind(this_: UdpSocket, network: Network, localAddress: IpSocketAddress): Promise<void>;
   finishBind(this_: UdpSocket): Promise<void>;
  /**
   ...
   */
   startConnect(this_: UdpSocket, network: Network, remoteAddress: IpSocketAddress): Promise<void>;
   finishConnect(this_: UdpSocket): Promise<void>;
  /**
   ...
   */
   receive(this_: UdpSocket, maxResults: bigint): Promise<Datagram[]>;
  /**
   ...
   */
   send(this_: UdpSocket, datagrams: Datagram[]): Promise<bigint>;
  /**
   ...
   */
   localAddress(this_: UdpSocket): Promise<IpSocketAddress>;
  /**
   ...
   */
   remoteAddress(this_: UdpSocket): Promise<IpSocketAddress>;
  /**
   * Whether this is a IPv4 or IPv6 socket.
   * 
   * Equivalent to the SO_DOMAIN socket option.
   */
   addressFamily(this_: UdpSocket): Promise<IpAddressFamily>;
  /**
   ...
   */
   ipv6Only(this_: UdpSocket): Promise<boolean>;
   setIpv6Only(this_: UdpSocket, value: boolean): Promise<void>;
  /**
   ...
   * - `concurrency-conflict`: (set) Another `bind` or `connect` operation is already in progress. (EALREADY)
   */
   unicastHopLimit(this_: UdpSocket): Promise<number>;
   setUnicastHopLimit(this_: UdpSocket, value: number): Promise<void>;
  /**
   ...
   * - `concurrency-conflict`: (set) Another `bind` or `connect` operation is already in progress. (EALREADY)
   */
   receiveBufferSize(this_: UdpSocket): Promise<bigint>;
   setReceiveBufferSize(this_: UdpSocket, value: bigint): Promise<void>;
   sendBufferSize(this_: UdpSocket): Promise<bigint>;
   setSendBufferSize(this_: UdpSocket, value: bigint): Promise<void>;
  /**
