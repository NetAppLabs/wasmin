export interface WasiClocksTimezoneAsync {
  /**
   ...
   * saving time.
   */
   display(this_: Timezone, when: Datetime): Promise<TimezoneDisplay>;
  /**
   * The same as `display`, but only return the UTC offset.
   */
   utcOffset(this_: Timezone, when: Datetime): Promise<number>;
  /**
   * Dispose of the specified input-stream, after which it may no longer
   * be used.
   */
   dropTimezone(this_: Timezone): Promise<void>;
}
