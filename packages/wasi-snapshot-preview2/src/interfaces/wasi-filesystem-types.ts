export interface WasiFilesystemTypesAsync {
  /**
...
export interface Descriptor extends AsyncDisposable {
...
export interface DirectoryEntryStream extends AsyncDisposable {
