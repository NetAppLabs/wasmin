...
export declare function instantiate(compileCore: (path: string, imports: Record<string, any>) => Promise<WebAssembly.Module>, imports: ImportObject, instantiateCore?: (module: WebAssembly.Module, imports: Record<string, any>) => Promise<WebAssembly.Instance>): Promise<Root>;
export interface Root {
    'wasi:cli/run': typeof WasiCliRun;
    run: typeof WasiCliRun;
}
export declare function fetchCompile(url: URL): Promise<WebAssembly.Module>;
export declare function compileCore(url: string): Promise<WebAssembly.Module>;
