(module
  ...
  (import "wasi_snapshot_preview1" "term_set_raw_mode" 
    (func $term_set_raw_mode (param i32) (result i32)))
  (import "wasi_snapshot_preview1" "term_get_raw_mode" 
    (func $term_get_raw_mode (result i32)))
  (import "wasi_snapshot_preview1" "term_get_rows" 
    (func $term_get_rows (result i32)))
  (import "wasi_snapshot_preview1" "term_get_columns" 
