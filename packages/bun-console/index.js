...
switch (platform) {
  ...
  case 'linux':
    switch (arch) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'bun-console.linux-riscv64-musl.node'))
          try {
            if (localFileExisted) {
              nativeBinding = require('./bun-console.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('@wasmin/bun-console-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
        } else {
          localFileExisted = existsSync(join(__dirname, 'bun-console.linux-riscv64-gnu.node'))
          try {
            if (localFileExisted) {
              nativeBinding = require('./bun-console.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('@wasmin/bun-console-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
