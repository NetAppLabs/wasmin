...
const $init = (async() => {
  ...
  const { instance: instance0 } = await instantiateCore2(await module0, instance0Imports);
  ...
  const { instance: instance3 } = await instantiateCore2(await module3, instance3Imports);
